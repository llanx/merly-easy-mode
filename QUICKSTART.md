...
Use [docs/codex-config-example.md](docs/codex-config-example.md) and replace `<checkout>` with your local repository path.

After Codex can see the MCP server, try:
