...
Detailed endpoint notes live in `../docs/merly-openapi-summary.md`.
...
7. Record repository id, branch id, RBL id, latest snapshot id, language, branch, and commit in the handoff or verification artifact when those ids are needed for later review.
...
Avoid early prototype fixes for:
